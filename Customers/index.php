...
<head>
    ...
    <title>Flippedt.ph</title>
	 <link rel="shortcut icon" href="../assets/img/Picture1.png" type="image/x-icon" />
...
<body  style="background-color:black">
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Flippedt.ph</a>
            </div>
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <img src="../assets/img/Picture1.png" alt="Hero Slide" style="width:100%;height:500px;">
        ...
        <div class="item">
            <img src="../assets/img/3.png" alt="..." style="width:100%;height:500px;">
        ...
        <div class="item">
            <img src="../assets/img/4.png" alt="..." style="width:100%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/5.png" alt="..." style="width:100%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/2.png" alt="..." style="width:100%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/1.png" alt="..." style="width:100%;height:500px;">
