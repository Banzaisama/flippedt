...
<head>
    ...
    <title>Flippedt.ph Online Clothing</title>
...
<body>
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img class="logo-custom" src="assets/img/picture1.png" alt=""  /></a>
            </div>
 ...
 <div class="container">
               ...
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        <!-- Slider 01 -->
                        <li>
                              <h3>High Quality Aesthetic Clothes</h3>
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> Flippedt.ph <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
     ...
     <div class="modal fade" id="su" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-sm">
            <div style="color:pink;background-color:pink" class="modal-content">
